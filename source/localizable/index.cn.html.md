...
### HTTP请求
**GET /api/v1/accounts/transferable-balance**

### 请求示例
GET /api/v1/accounts/transferable-balance?currency=BTC&type=MAIN
...
| 请求参数   | 类型     | 含义        |
| ------ | ------ | --------- |
| currency | String | 借入币种 |
| type | String | 类型：FOK、IOC |
| size | BigDecimal | 借入数量 |
| maxRate | BigDecimal | 最大利率,非必填,不填则表示接受所有利率 |
| term | Int | 期限,单位为:天,非必填,不填则表示接受所有期限,逗号隔开,如: 7,14,28 |
